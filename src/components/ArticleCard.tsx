...
export function ArticleCard({ article }: { article: Article }) {
  return (
    <a
      ...
      className="group flex flex-col overflow-hidden rounded-3xl border border-border bg-card paper-shadow transition-transform duration-200 hover:-translate-y-1 sm:flex-row"
    >
      <div className="relative h-48 shrink-0 overflow-hidden sm:h-auto sm:w-56 md:w-72">
        <Image
          src={article.cover}
          alt=""
          width={960}
